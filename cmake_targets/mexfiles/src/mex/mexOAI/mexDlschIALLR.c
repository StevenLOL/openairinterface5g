...
void mexDlschIALLR( int nlhs, mxArray *plhs[],
                ...
                )
{
  ...
  tmp = mxGetField(prhs[5],0,"nb_antennas_tx_eNB");
  if (tmp == NULL) {
    mexErrMsgTxt("Non-existing field 'nb_antennas_tx_eNB' in input argument 6.");
  } else {
