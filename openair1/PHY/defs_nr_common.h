...
#define NR_PBCH_DMRS_LENGTH 144 //24// in mod symbols
...
#define NR_MAX_PDCCH_DMRS_INIT_LENGTH_DWORD 52 //275*6/32 // ceil(NR_MAX_PDCCH_DMRS_LENGTH/32)
...
#define NR_MAX_PDSCH_DMRS_INIT_LENGTH 1100      //275*2(k)*2(QPSK)
#define NR_MAX_PDSCH_DMRS_INIT_LENGTH_DWORD 35  // ceil(NR_MAX_PDCCH_DMRS_LENGTH/32)
