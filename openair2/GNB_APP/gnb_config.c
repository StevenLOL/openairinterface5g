...
void RCconfig_nr_flexran()
{
  ...
  int32_t   eutra_band, uplink_frequency_offset, N_RB_DL, nb_antenna_ports,
            MIB_subCarrierSpacingCommon, ssb_subcarrier_offset, MIB_dmrs_TypeA_Position,
...
void RCconfig_NRRRC(MessageDef *msg_p, uint32_t i, gNB_RRC_INST *rrc) {
  ...
  int32_t                ssb_subcarrier_offset                                      = 0;
        ...
        if ( CCsParamList.numelt> 0) {
          ...
          for (j = 0; j < CCsParamList.numelt ;j++) {
            ...
            */
            ...
            NRRRC_CONFIGURATION_REQ (msg_p).ssb_subcarrier_offset[j] = ssb_subcarrier_offset;
            if ((ssb_subcarrier_offset <0) || (ssb_subcarrier_offset > 15)){
              AssertFatal (0,"Failed to parse gNB configuration file %s, gnb %d unknown value \"%d\" for ssb_subcarrier_offset choice: 1..23 !\n",
                           RC.config_file_name, i, ssb_subcarrier_offset);
            }
            ...
            NRRRC_CONFIGURATION_REQ (msg_p).ssb_subcarrier_offset[j] = ssb_subcarrier_offset;
            if ((ssb_subcarrier_offset <1) || (ssb_subcarrier_offset > 23)){
              AssertFatal (0,"Failed to parse gNB configuration file %s, gnb %d unknown value \"%d\" for ssb_subcarrier_offset choice: 1..23 !\n",
                           RC.config_file_name, i, ssb_subcarrier_offset);
            }
            ...
            NRRRC_CONFIGURATION_REQ (msg_p).ra_coreset[j] = ra_coreset;
            if ((ra_coreset <0) || (ra_coreset>11)){
              AssertFatal (0,"Failed to parse gNB configuration file %s, gnb %d unknown value \"%d\" for ra_coreset choice: 0..11 !\n",
                           RC.config_file_name, i, ra_coreset);
            }
